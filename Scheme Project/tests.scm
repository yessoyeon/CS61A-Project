...
(define lamb (lambda (x) (+ x sheep)))
; expect lamb

(lamb 7)
; expect 14

(let ((a 1) (b 2)) ((begin (define a b) (if (= a b) + -)) 5 5))
; expect 10

(define (abcd a b) (let ((c (- b a)) (d (+ a b))) (+ a b c d)))
; expect abcd
...
(define (beginner z) (+ (begin (define x (begin (define x 100) (define y 200) (/ y x))) (begin (define y (+ x y)) y)) z))
; expect beginner
...
(define (expert x) (beginner (* x 100)))
; expect expert
