...
# BEGIN Problem 8
class WallAnt(Ant):
    """WallAnt has a large armor value for defense"""
...
class ScubaThrower(ThrowerAnt):
    """A Thrower Ant that is also water safe"""
...
# END Problem 13
    ...
    def __init__(self):
        # BEGIN Problem 13
        Ant.__init__(self, 1)
        if QueenAnt.is_queen == True:
            self.true_queen = False
        elif QueenAnt.is_queen == False:
